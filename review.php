        ...
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="container">
                    ...
                    <i class="fa fa-star fa-2x star-rev" data-index="6"></i>
                    <i class="fa fa-star fa-2x star-rev" data-index="7"></i>
                    <i class="fa fa-star fa-2x star-rev" data-index="8"></i>
                    <i class="fa fa-star fa-2x star-rev" data-index="9"></i>
                    <i class="fa fa-star fa-2x star-rev" data-index="10"></i>
